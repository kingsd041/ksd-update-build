...
export REPO_LIST="rancher rke rke2 system-charts helm3-charts charts rancher-catalog community-catalog install-docker k3s kontainer-driver-metadata fleet partner-charts harvester ui-plugin-charts rke2-charts virtual-clusters-ui cluster-template-examples"
